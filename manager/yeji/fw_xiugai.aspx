...
conn.execute("insert tbl_queren(huiyuan_id,huiyuan_zhuanmai,queren_money,queren_date,memo,queren_type,money_before,queren_man) values('"+huiyuan_id+"','A00000000',"+money+",getdate(),'服务中心充值',1,"&money_b&",'"&session("hy_bianhao")&"')")
