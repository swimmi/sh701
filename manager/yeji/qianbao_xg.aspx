...
conn.execute("update tbl_huiyuan set huiyuan_fa=huiyuan_fa+"&money&" where huiyuan_id='"&huiyuan_id&"'")
...
rs_read.Open SQL,conn,1,1
	money_b=round(rs_read("huiyuan_fa"),2)
rs_read.close
set rs_read=nothing

conn.execute("insert tbl_queren(huiyuan_id,huiyuan_zhuanmai,queren_money,queren_date,memo,queren_type,money_before,queren_man) values('"+huiyuan_id+"','A00000000',"+money+",getdate(),'管理员充值奖金币',1,"&money_b&",'"&session("hy_bianhao")&"')")
