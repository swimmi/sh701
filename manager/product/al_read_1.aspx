...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2">订单查询</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 兑换管理 &gt; 订单查询</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />订单查询</td>
  </tr>
  <tr>
               ...
               <table width="99%" height="40" border="0" align="center" cellspacing="0" class="content">
                 <tr valign="top">
                   <td height="30" align="left" valign="middle">查询： 按
                     ...
                     <a href="al_read_1_out.aspx?type=<%=request("type")%>&search=<%=request("search")%>&shijian1=<%=request("shijian1")%>&shijian2=<%=request("shijian2")%>">导出列表</a> </td>
                 </tr>
               </table>
           </form></td>
         </tr>
