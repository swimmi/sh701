...
if request.form("submit")="确认修改" then
	...
	rs("gonggao") =request("memo")
	rs.Update
	rs.close
	set rs=nothing
	
	response.Write "<script language=javascript>alert('操作成功！');location.href='gonggao.aspx';</script>"
	response.end
...
<form id="form1" name="form1" method="post" action="gonggao.aspx">
	  <table width="100%" border="0" cellpadding="0" cellspacing="1">
	
		<tr>
		  <td align="center"><textarea name="memo" style="width:99%;height:400px;visibility:hidden;"><%=rs("gonggao")%></textarea><br />
