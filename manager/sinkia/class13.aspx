...
<%
	if request("action")="add" then
		...
		response.Write "<script language=javascript>alert('添加成功！');location.href='class13.aspx';</script>"
		response.end
...
<%
	...
	if request("Submit")="修改" then
		...
		response.Write "<script language=javascript>alert('操作成功！');location.href='class13.aspx';</script>"
		response.end
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="content">
        <tr>
          ...
          <td width="110" height="40" align="left" ><input type="submit" name="Submit" value="修改关键字" style="border:1px #CCCCCC solid; background-color:#FFFFFF; line-height:20px; font-family:'微软雅黑';" onClick="javascript:location.href='class13.aspx'" disabled/></td>
	  ...
	  <hr color="#FF9900" />
        ...
        <tr bgcolor="#e1e1e1" class="titlea1">
          <td width="50%" height="40" align="center" >关键字</td>
          </tr>
<%
...
<form id="form1" name="form1" method="post" action="?">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><input type="text" name="guanjian" value="<%=rs("guanjian")%>" style="width:250px; height:20px; line-height:20px; font-family:'微软雅黑'" />
