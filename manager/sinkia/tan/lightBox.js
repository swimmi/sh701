...
function Box(objID,W,H,inner,footerInner){
	...
	//创建html结构并赋id以及class		
		...
		objHead.innerHTML='<div class="headerL" id='+headerLid+'><span style="float:right;background:url(tan/lightbox-close.png) no-repeat 0 center;display:inline-block;height:46px;width:16px;cursor:pointer;" id='+closeBtn+'></span></div><div class="headerR"></div>';
		...
		obj.style.cssText+=";position:absolute;left:50%;top:300px;z-index:901;";		
