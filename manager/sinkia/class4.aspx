  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF" style="padding-top:10px; padding-bottom:10px;"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="content">
      <tr>
        ...
        <td width="110" height="40" align="left" ><input type="submit" name="Submit2" value="添加类别" style="border:1px #CCCCCC solid; background-color:#FFFFFF; line-height:20px; font-family:'微软雅黑';" onclick="javascript:location.href='class4.aspx'" disabled/></td>
...
<%
	if request("action")="add" then
		...
		response.Write "<script language=javascript>alert('添加成功！');location.href='class4.aspx';</script>"
		response.end
...
%>
      ...
      <form id="form1" name="form1" method="post" action="?">
        <table width="1000" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="500" height="30" align="right"><strong>添加类别</strong></td>
            <td width="500" height="30" align="left">&nbsp;</td>
          </tr>
          <tr>
            <td width="500" height="30" align="right">类别：</td>
