...
<%
	if request("action")="add" then
		...
		if request("yue")="" then
			response.Write "<script language=javascript>alert('请填写月龄段！');location.href='class2.aspx';</script>"
			response.end
		end if
		...
		response.Write "<script language=javascript>alert('添加成功！');location.href='class12.aspx';</script>"
		response.end
...
<%
	...
	if request("Submit")="修改" then
		...
		conn.execute("update yue set yue='"&request("yue")&"' where id='"&request("id")&"'")
	
		response.Write "<script language=javascript>alert('操作成功！');location.href='class12.aspx';</script>"
		response.end
	...
	if request("action")="del" then
		...
		conn.execute("delete yue where id='"&request("id")&"'")
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="content">
        <tr>
          <td width="100" height="40" align="left" ><input type="submit" name="Submit" value="修改周龄" style="border:1px #CCCCCC solid; background-color:#FFFFFF; line-height:20px; font-family:'微软雅黑';" onClick="javascript:location.href='class11.aspx'"  /></td>
          <td width="110" height="40" align="left" ><input type="submit" name="Submit" value="修改月龄段" style="border:1px #CCCCCC solid; background-color:#FFFFFF; line-height:20px; font-family:'微软雅黑';" onClick="javascript:location.href='class12.aspx'" disabled/></td>
	  ...
	  <form id="form1" name="form1" method="post" action="?">
        <table width="99%" border="0" cellpadding="0" cellspacing="0" style="border:1px #CCCCCC solid">
          <tr>
            <td width="100" height="30" align="left">&nbsp;&nbsp;&nbsp;&nbsp;月龄段：</td>
            <td height="30" align="left">
				<input name="yue" type="text" id="yue" />
        ...
        <tr bgcolor="#e1e1e1" class="titlea1">
          <td width="50%" height="40" align="center" >月龄段</td>
          </tr>
<%
...
<form id="form1" name="form1" method="post" action="?">
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><input type="text" name="yue" value="<%=rs("yue")%>" style="width:250px; height:20px; line-height:20px; font-family:'微软雅黑'" />
