...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  ...
  <tr><td align="left" ><!--<a href="?action=add">添加</a>　　--><a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_sinkia_iimgs where (type=2 or type=3 or type=4) order by id "
...
set rs=nothing
 ...
 <br><table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
      <form action="i_imgs_saveuploadb.aspx"  enctype="multipart/form-data" name="form1" method="post">
<tr>
     ...
     <td height="25" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
 	 ...
 	 <tr bgcolor="#DCE2ED">
       ...
       <td width="85%" height="12" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
         ...
         ，<%if Rs("type")=2 then%>尺寸：265*332<%end if%>
        <%if Rs("type")=3 then%>
        ，尺寸：240*300
        <%end if%><%if Rs("type")=4 then%>，尺寸：1000*120<%end if%><%if Rs("type")=9 then%>，尺寸：588*58<%end if%></span></td>
     </tr>
