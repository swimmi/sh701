...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  ...
  <tr>
    ...
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 商品管理 &gt; 商品管理</td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td width="64%" align="left" ><a href="?action=add">添加</a>　　<a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_product where 1=1 and pro_type=1"
	if request("pid")&""<>"" then
...
<table width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c1c1c1">
  ...
  <tr bgcolor="FFFFFF" onmouseover="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
	...
	<a href="addd.aspx?id=<%=Rs("pro_id")%>">菜酒配</a>　<a href="adde.aspx?id=<%=Rs("pro_id")%>">添加属性</a> </span></td>
  </tr>
  <%
			Rs.MoveNext
			ic=ic-1
...
<form action="product_upload.aspx"  enctype="multipart/form-data" name="form1" method="post"><tr>
  ...
  <tr>
    <td height="25" align="right" bgcolor="#FFFFFF">所属国家：</td>
    <td height="25" align="left" bgcolor="#FFFFFF"><select name="pro_pid" id="pro_pid">
        <%
