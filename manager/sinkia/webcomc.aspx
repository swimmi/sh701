...
if request.form("submit")="确认修改" then
	...
	rs.close
	set rs=nothing
	response.Write "<script language=javascript>alert('操作成功！');location.href='webcom.aspx';</script>"
	response.end
end if
   %>
<%
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  ...
  <tr>
    ...
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 网上商城 &gt; 帮助中心 &gt; <%=rs("title")%> &gt; 修改内容</td>
  </tr>
</table>
...
<form id="form1" name="form1" method="post" action="webcomc.aspx">
