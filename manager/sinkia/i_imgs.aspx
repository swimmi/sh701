...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  ...
  <tr><td align="left" ><!--<a href="?action=add">添加</a>　　--><a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_sinkia_iimgs where type=1 order by id "
...
<%
		while not Rs.eof 
%>
  <tr><td align="center" bgcolor="#FFFFFF" class="content" ><img src="<%=rs("imgs")%>" height="50"></td>
...
set rs=nothing
 ...
 <br><table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
  ...
  <tr>
    <td width="15%" height="25" align="center" bgcolor="#FFFFFF">链接地址：</td>
    <td width="85%" height="25" align="left" bgcolor="#FFFFFF">
      ...
      *       </span></td>
 	 ...
 	 <tr bgcolor="#DCE2ED">
       <td height="12" align="center" bgcolor="#FFFFFF">大图片：</td>
     ...
     <tr bgcolor="#DCE2ED">
       <td height="12" align="center" bgcolor="#FFFFFF">小图片：</td>
       <td height="12" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
         <input name="imgs2" type="file" id="imgs2"/>
       图片格式：gif/jpg 图片大小&lt;150K
         ，尺寸：120*70</span></td>
     </tr>
  <tr>
