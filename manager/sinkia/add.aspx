...
<%
	...
	sql="select * from tbl_product where id="&request("id")&""
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
  <form action="add1.aspx" method="post"  enctype="multipart/form-data" name="form1" id="form1">
    <tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="content">
  <tr>
    <%
	Set Rs= Server.CreateObject("ADODB.Recordset")
	sql="select * from tbl_photo where pro_id="&request("id")&""
	rs.Open SQL,conn,1,1
	dim i
	i=1
        ...
        <table border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <td bgcolor="#FFFFFF"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="125" valign="middle"><img src="<%=rs("url")%>" width="100" height="120" /></td>
                </tr>
                <tr>
                  <td height="25" align="center"><a href="add_del.aspx?id=<%=rs("id")%>&amp;proid=<%=request("id")%>">删除</a></td>
                </tr>
            </table></td>
          </tr>
      </table></td>
