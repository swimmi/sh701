...
if UpFile.Form("imgs")="" then
	...
	response.end
		...
		Rs.Open ("select * from tbl_product where pro_id="&UpFile.Form("proid")&""),Conn,3,3
							if UpFile.Form("imgs")&""<>"" then
								Rs("url")  = "UpLoadFile_Pimg/"&UpFile.Form("imgs")
							end if
							Rs("urlpm")  = UpFile.Form("urlpm")
							Rs.Update
							Rs.Close
								Response.Redirect "addb.aspx?id="&UpFile.Form("proid")	
					set rs=nothing
