...
shijian=UpFile.Form("shijian_jp")&" "&UpFile.form("shi")&":"&UpFile.form("fen")&":"&UpFile.form("miao")
...
if UpFile.Form("imgs")="" then
		  ...
		  response.end
					...
					Rs.Open ("select * from tbl_product"),Conn,3,3
							...
							Rs("shijian_jp")   =   shijian
							Rs("pro_date")      =   now()
							
							Rs.Update
							Rs.Close

								Response.Redirect "product.aspx?action=addsave"
					set rs=nothing
