...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2">积分换购</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 网上商城 &gt; 积分换购</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />积分换购</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td width="64%" align="left" ><a href="?action=add">添加</a>　　<a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_product where jf=1"
	if request("pid")&""<>"" then
...
<table width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c1c1c1">
  <tr bgcolor="#e1e1e1" class="titlea1" >
    ...
    <td height="35" align="center">积分</td>
    <td align="center">换购价</td>
    <!-- <td height="35">状态</td>
    <td>发布者</td>-->
  ...
  <tr bgcolor="FFFFFF" onmouseover="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
    ...
    <td height="90" align="center" class="content"><span class="tdc"><%=Rs("pro_price")%></span></td>
    <td align="center" class="content"><span class="tdc">价格：<%=Rs("hg_money")%> 积分：<%=Rs("hg_jf")%></span></td>
    <!-- <td height="90" align="center" class="content"><span class="tdc">
      <%if rs("pro_isok")=0 then%>
      未审核
      <%else%>
      已审核
      <%end if%>
    </span></td>
    <td align="center" class="content"><span class="tdc"><%if rs("pro_user")="a00000000" or rs("pro_user")="A00000000" then%>公司<%else%><%=Rs("pro_user")%><%end if%></span></td>-->
    <td height="90" align="center" class="content"><span class="tdc"><a href="?action=mod&amp;id=<%=Rs("pro_id")%>">修改</a>　<a href="?id=<%=Rs("pro_id")%>&amp;action=del" onClick="if(confirm('你确定你要这样操作吗？删除将不能恢复！')){return true;}else{return false;}">删除</a>　<a href="add.aspx?id=<%=Rs("pro_id")%>">添加图片</a>　<a href="addac.aspx?id=<%=Rs("pro_id")%>">添加成份</a></span></td>
  </tr>
  <%
			Rs.MoveNext
			ic=ic-1
...
<form action="product_upload_j.aspx"  enctype="multipart/form-data" name="form1" method="post"><tr>
  ...
  <tr >
    <td height="25" align="right" bgcolor="#FFFFFF"><span class="STYLE11">换购价：</span></td>
    <td height="25" align="left" bgcolor="#FFFFFF"><input name="hg_money" type="text" id="hg_money" size="10" />
      －
<input name="hg_jf" type="text" id="hg_jf" size="10" />
<span class="STYLE1"> * </span></td>
  </tr>
  <tr style="display:none">
...
set rs=nothing
 ...
 <br><table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
   <form action="product_saveupload_j.aspx"  enctype="multipart/form-data" name="form1" method="post">
  ...
  <%end if%>
  <tr>
    <td width="15%" height="25" align="right" bgcolor="#FFFFFF">积分：</td>
    <td width="85%" height="25" align="left" bgcolor="#FFFFFF">
  ...
  <tr >
    <td height="25" align="right" bgcolor="#FFFFFF"><span class="STYLE11">换购价：</span></td>
    <td height="25" align="left" bgcolor="#FFFFFF"><input name="hg_money" type="text" id="hg_money" value="<%=Rs("hg_money")%>" size="10" />
      －
      <input name="hg_jf" type="text" id="hg_jf" value="<%=Rs("hg_jf")%>" size="10" />
      <span class="STYLE1"> * </span></td>
  </tr>
  <tr style="display:none">
