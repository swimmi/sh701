...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2" align="left">关于我们图片</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" align="left" bgcolor="EEEEEE" class="titlea">首页 &gt; 商城信息 &gt; 关于我们图片</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" align="left" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />关于我们图片</td>
  </tr>
  <tr>
  ...
  <tr><td align="left" ><!--<a href="?action=add">添加</a>　　--><a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_about where id>=8 order by id "
...
<%
		while not Rs.eof 
%>
  <tr><td height="110" align="center" bgcolor="#FFFFFF" class="content" ><img src="<%=rs("title")%>" height="50"></td>
...
sql="select * from tbl_about where id="&request("id")
...
Set FSO = Nothing
	 ...
	 sql="delete from tbl_about where id="&request("id")
...
set rs=nothing
 ...
 <br><table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
      <form action="abouta1.aspx"  enctype="multipart/form-data" name="form1" method="post">
<tr>
