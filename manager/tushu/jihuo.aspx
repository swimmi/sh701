...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    ...
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 系统设置 &gt; 激活码管理</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />激活码管理</td>
  </tr>
  <tr>
...
%>
       ...
       <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <input name="Submit2" type="submit" id="Submit" value="查询" />
                   ...
                   <td height="30" align="right" valign="middle"><input name="Submit222" type="submit" id="Submit22" value="导出激活码" onclick="javascript:location.href='jihuo_dao.aspx?type=<%=request("type")%>&search=<%=request("search")%>&shijian1=<%=request("shijian1")%>&shijian2=<%=request("shijian2")%>'" />
