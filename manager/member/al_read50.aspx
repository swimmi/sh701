...
SQL="select * from view_huiyuan where   huiyuan_id<>'A00000000' and huiyuan_suoding=1 and huiyuan_jiebie=2 "&search_sql&"   and huiyuan_add_time between '"&session("date1")&"' and '"&session("date2")&"' order by huiyuan_add_time desc"
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
    <tr>
      <td height="80" colspan="2">查封商户</td>
    </tr>
    <tr>
      <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
      <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 商户管理 &gt; 查封商户</td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
    <tr class="biao">
      <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />查封商户</td>
    </tr>
    <tr>
...
%>
          ...
          <td height="30" align="center" class="content"><%if rs("huiyuan_suoding")=0 then%>
            ...
            <%else%>
            <a href="dj1.aspx?flag=1&amp;id=<%=rs("huiyuan_id")%>"><font color="#FF0000">查封中</font></a>
          <%end if%></td>
          <td height="30" align="center" class="content"><a href="al_infod.aspx?huiyuan_id=<%=rs("huiyuan_id")%>">修改资料</a></td>
        </tr>
          <%
			  i=i+1
			  icolor=icolor+1
