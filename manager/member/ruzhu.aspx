...
if request("submit")="提交" then
	conn.execute("update tbl_zhidu set memo='"&request.Form("content")&"' where id=11")
		
	response.Write "<script language=javascript>alert('操作成功！');location.href='ruzhu.aspx';</script>"
	response.end
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2" align="left">入驻协议</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" align="left" bgcolor="EEEEEE" class="titlea">首页 &gt; 商户管理 &gt; 入驻协议</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" align="left" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />入驻协议</td>
  </tr>
  <tr>
...
<%
	...
	Rs.Open ("select * from tbl_zhidu where id=11"),Conn,1,1
%>
