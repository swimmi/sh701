...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao">
  <tr>
    <td height="30" align="center" background="../images/contop_bg.jpg">退单管理</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="0" align="center" cellpadding="1"  cellspacing="1" bgcolor="999999">
  <tr bgcolor="#E3E3E3">
    ...
    <td align="center" bgcolor="#CCCCCC" class="title" >申请时间</td>
    <td align="center" bgcolor="#CCCCCC" class="title" >状态</td>
...
%>
  <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
    ...
    <td align="center" class="content"><%if rs("flag")=0 then%>
      <span class="STYLE1">未审核</span>
<%end if%><%if rs("flag")=1 then%>
<span class="STYLE2">已审核</span>
<%end if%><%if rs("flag")=2 then%>
<span class="STYLE3">未通过</span>
<%end if%></td>
    <td height="35" align="center" class="content">
      <%if rs("flag")<>1 then%><a href="tui1.aspx?id=<%=rs("id")%>&a=1">确认退单</a> &nbsp;<%end if%> <%if rs("flag")<>2 then%><a href="tui1.aspx?id=<%=rs("id")%>&a=2">取消退单</a><%end if%></td>
  </tr>
  <%
			  i=i+1
			  icolor=icolor+1
