...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
    <tr>
      <td height="80" colspan="2">商户认证</td>
    </tr>
    <tr>
      <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
      <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 商户管理 &gt; 商户认证</td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
    <tr class="biao">
      <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />商户认证</td>
    </tr>
    <tr>
...
%>
          ...
          <td height="30" align="center" class="content">
			  ...
			  <a href="rz.aspx?huiyuan_id=<%=rs("huiyuan_id")%>">安全认证</a>		  </td>
        </tr>
          <%
			  i=i+1
			  icolor=icolor+1
