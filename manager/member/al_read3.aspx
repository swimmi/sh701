...
SQL="select * from huiyuan where flag=1 "&search_sql&" and addtime between '"&session("date1")&"' and '"&session("date2")&"' order by addtime desc"
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
    <tr>
      <td height="80" colspan="2">会员黑名单</td>
    </tr>
    <tr>
      <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
      <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 会员管理 &gt; 黑名单</td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
    <tr class="biao">
      <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />黑名单</td>
    </tr>
    <tr>
...
%>
          <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onmouseout="this.style.backgroundColor=''">
            ...
            <td align="center" class="content"><%=rs("yzm")%></td>
            <td height="30" align="center" class="content"><%=rs("addtime")%></td>
          <td height="30" align="center" class="content"><%if rs("flag")=0 then%>
            <a href="dj.aspx?flag=0&amp;id=<%=rs("flag")%>">正常</a>
            <%else%>
				<a href="dj1.aspx?flag=1&amp;id=<%=rs("id")%>"><font color="#FF0000">查封中</font></a>
          <%end if%></td>
          <td height="30" align="center" class="content"><a href="al_infoa.aspx?huiyuan_id=<%=rs("id")%>">查看资料</a></td>
        </tr>
          <%
			  i=i+1
			  icolor=icolor+1
