...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao">
  <tr>
    <td height="30" align="center" background="../images/contop_bg.jpg">已开通会员列表</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
SQL="select * from view_huiyuan where   huiyuan_id<>'A00000000' and net_hege=1 "&search_sql&"   and huiyuan_add_time between '"&session("date1")&"' and '"&session("date2")&"' order by huiyuan_add_time desc"
...
<table width="100%" border="0" align="center" cellpadding="1"  cellspacing="1" bgcolor="999999">
  <tr bgcolor="#E3E3E3">
    ...
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >会员级别</td>
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >推荐人</td>
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >安置人</td>
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >服务中心</td>
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >注册时间</td>
    <td align="center" bgcolor="#CCCCCC" class="title" >确认时间</td>
    <td height="35" align="center" bgcolor="#CCCCCC" class="title" >操作</td>
  </tr>
  <%
		  	dim i
			i=1
...
%>
  <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
    ...
    <td height="35" align="center" class="content"><%=rs("tjr_bianhao")%></td>
    <td height="35" align="center" class="content"><%=rs("jdr_bianhao")%></td>
    <td height="35" align="center" class="content"><%=rs("zmd_bianhao")%></td>
    <td height="35" align="center" class="content"><%=formatdatetime(cstr(rs("huiyuan_add_time")),1)%></td>
    <td align="center" class="content"><%if isnull(rs("huiyuan_qr_date"))=false then
    response.write formatdatetime(cstr(rs("huiyuan_qr_date")),1)
end if%>
    </td>
    <td height="35" align="center" class="content">
      <a href="al_info.aspx?huiyuan_id=<%=rs("huiyuan_id")%>">修改资料</a> </td>
  </tr>
  <%
			  i=i+1
			  icolor=icolor+1
