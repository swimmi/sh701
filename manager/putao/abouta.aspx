...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2" align="left">图片</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" align="left" bgcolor="EEEEEE" class="titlea">首页 &gt; 发烧友之家 &gt; 图片</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" align="left" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />图片</td>
  </tr>
  <tr>
  ...
  <tr><td align="left" ><!--<a href="?action=add">添加</a>　　--><a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_sinkia_iimgs where type=7 or type=8 order by id "
...
<table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#c1c1c1" >
  <tr bgcolor="#e1e1e1"  class="titlea1">
    ...
    <td width="237" height="35" align="center" >链接地址</td>
    <td width="127" align="center" >操作/管理</td>
  </tr>
<%
		while not Rs.eof 
%>
  <tr><td align="center" bgcolor="#FFFFFF" class="content" ><img src="../sinkia/<%=rs("imgs")%>" height="50"></td>
...
<form action="i_imgs_upload.aspx"  enctype="multipart/form-data" name="form1" method="post">
  <tr>
   ...
   <form action="i_imgs_saveupload.aspx"  enctype="multipart/form-data" name="form1" method="post">
 	 <tr bgcolor="#DCE2ED">
       ...
       <td width="85%" height="12" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
         ...
         ，尺寸：1000*<%if rs("type")=7 then%>200<%else%>122<%end if%></span></td>
 	 </tr>
