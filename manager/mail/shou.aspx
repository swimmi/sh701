...
SQL="select * from view_liuyan where leibie=2 order by liuyan_date desc"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2">咨询及投诉</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 消息留言 &gt; 咨询及投诉</td>
  </tr>
</table>
  ...
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="1"  cellspacing="1" bgcolor="999999">
	  <tr bgcolor="#E3E3E3" class="titlea1">
		...
		<td width="816" height="40" align="center">标题</td>
	...
	%>
	  <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
		...
		<td height="30" align="center" class="content"><a href="show.aspx?id=<%=rs("id")%>"><%=rs("liuyan_title")%></a></td>
		<td width="150" height="30" align="center" class="content"><%=rs("liuyan_date")%></td>
		<td width="120" height="30" align="center" class="content"><a href="show.aspx?id=<%=rs("id")%>">查看</a>&nbsp;<a href="zhixun.aspx?id=<%=rs("id")%>">回复</a>&nbsp;<a href="del.aspx?id=<%=rs("id")%>">删除</a></td>
	  </tr>
	  <%
				  i=i+1
				  icolor=icolor+1
