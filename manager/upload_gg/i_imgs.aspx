...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2" align="left">广告位图片上传</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" align="left" bgcolor="EEEEEE" class="titlea">首页 &gt; 网上商城 &gt; 广告位图片上传</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" align="left" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />广告位图片上传</td>
  </tr>
  <tr>
  ...
  <tr><td align="left" ><!--<a href="?action=add">添加</a>　　--><a href="?">列表</a></td>
	...
	End Select
	Sub member()
	sql="select * from tbl_uploadgg order by id "
...
<table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#c1c1c1">
  <tr  bgcolor="#e1e1e1" class="titlea1" >
    <td width="531" height="40" align="center" >图片</td>
    <td width="146" height="40" align="center" >主标题</td>
    <td width="136" height="40" align="center"  style="display:none">副标题</td>
    <td width="237" height="40" align="center" >链接地址</td>
...
%>
  <tr>
  	<td align="center" bgcolor="#FFFFFF" class="content" ><img src="<%=rs("imgs")%>" width="100"></td>
  	<td height="110" align="center" bgcolor="#FFFFFF" class="content" ><%=Rs("title_z")%></td>
  	<td height="110" align="center" bgcolor="#FFFFFF" class="content"  style="display:none"><%=Rs("title")%></td>
  	<td height="110" align="center" bgcolor="#FFFFFF" class="content" ><%=Rs("address")%></td>
...
<form action="i_imgs_upload.aspx"  enctype="multipart/form-data" name="form1" method="post"><tr>
  ...
  <tr>
    ...
    <td width="85%" height="25" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
      ...
      *       图片格式：gif/jpg 图片大小&lt;150K，尺寸：200*455</span></td>
  </tr>
  <tr>
...
sql="select * from tbl_uploadgg where id="&request("id")
...
Set FSO = Nothing
	 ...
	 sql="delete from tbl_uploadgg where id="&request("id")
...
set rs=nothing
 ...
 <br><table width="96%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" class="content">
   <form action="i_imgs_saveupload.aspx"  enctype="multipart/form-data" name="form1" method="post">
	<tr>
    <td width="15%" height="25" bgcolor="#FFFFFF">主 标 题：</td>
    <td width="85%" height="25" align="left" bgcolor="#FFFFFF">
      <span class="STYLE1">
  ...
  <tr>
    ...
    <td width="85%" height="25" align="left" bgcolor="#FFFFFF">
     ...
     <tr bgcolor="#DCE2ED">
       <td height="12" align="left" bgcolor="#FFFFFF"><span class="STYLE1">
         <%if rs("imgs")&""<>"" then%>
         <img src="<%=rs("imgs")%>" width="400" height="258">
         <%else
	   response.Write "暂无图片"%>
         <%end if%>
       </span></td>
