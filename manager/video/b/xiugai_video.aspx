...
%>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:10px;">
                      <tr>
                        ...
                        <td width="80%" height="40" align="left" style="font-weight:normal">
						<input type="submit" name="Submit32" value="视频信息" style="height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;" onclick="javascript:location.href='xiugai.aspx?id=<%=request("id")%>'" />
                          <input type="submit" name="Submit33" value="上传视频" style="height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;"  disabled="disabled"  onclick="javascript:location.href='xiugai_video.aspx?id=<%=request("id")%>'" />
                          <input type="submit" name="Submit3" value="第三方视频" style="height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;"  onclick="javascript:location.href='xiugai_videob.aspx?id=<%=request("id")%>'" /></td>
                      </tr>
                      <tr>
...
<form id="form1" name="form1" method="post" action="xiugai_videoa.aspx">
                        <tr>
                          <td height="40" align="right">&nbsp;</td>
                        ...
                        <tr>
                          <td height="40" align="right">                          </td>
                          <td height="40" align="left"><input type="submit" id="Submit" name="Submit4" value="确认修改" style="width:80px; height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;" onClick="swfu.startUploadFiles();"/></td>
                        </tr>
                      </form>
                  </table></td>
              </tr>
