...
%>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:10px;">
                      <tr>
                        ...
                        <td width="80%" height="40" align="left" style="font-weight:normal"><input type="submit" name="Submit3" value="上传视频" style="height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;"   onclick="javascript:location.href='indexa.aspx?leibie=2&id=<%=request("id")%>'" />
                            <input type="submit" name="Submit3" value="第三方视频" style="height:25px; border:1px #BCBCBC solid; background-color:#f4f4f4;"  onclick="javascript:location.href='indexb.aspx?leibie=2&id=<%=request("id")%>'" disabled/>                        </td>
                      </tr>
<form id="form1" name="form1" method="post" action="chuanb.aspx">
                        <tr>
                          ...
                          <td height="40" align="left">
							 ...
							 <textarea name="video" rows="10" id="video" style="width:400px; border:1px #CCCCCC solid; color:#000000"></textarea></input>						   </td>
                        </tr>
                        <tr>
