...
SQL="select * from tbl_login where login_flag=0 order by login_date desc"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2">会员登录日志</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 辅助功能 &gt; 会员登录日志</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />会员登录日志</td>
  </tr>
  <tr>
...
<table width="99%" border="0" align="center" cellpadding="1"  cellspacing="1" bgcolor="c1c1c1">
  <tr bgcolor="#e1e1e1" class="titlea1">
    ...
    <td height="40" align="center" >登录IP地址</td>
    <td height="40" align="center" >登录时间</td>
  </tr>
  <%
		  	dim i
			i=1
...
%>
  <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
    ...
    <td height="30" align="center" class="content"><%=rs("huiyuan_ip")%></td>
    <td height="30" align="center" class="content"><%=rs("login_date")%></td>
  </tr>
  <%
			  i=i+1
			  icolor=icolor+1
