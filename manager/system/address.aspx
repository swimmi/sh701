...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td height="80" colspan="2">地区添加</td>
  </tr>
  <tr>
    <td width="2%" align="center" bgcolor="EEEEEE"><img src="../images/3.jpg" width="13" height="10" /></td>
    <td width="98%" height="40" bgcolor="EEEEEE" class="titlea">首页 &gt; 系统设置 &gt; 地区添加</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="FFB849">
  <tr class="biao">
    <td height="40" style="padding-left:10px;"><img src="../images/4.jpg" width="18" height="15" />地区添加</td>
  </tr>
  <tr>
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="content">
  <tr>
    <td height="40" align="center">添加省名：
...
<form action="address.aspx" method="post">
  <tr bgcolor="FFFFFF" onMouseOver="this.style.backgroundColor='#F1F1F1'"  onMouseOut="this.style.backgroundColor=''">
      <td height="30" align="center" class="content"><input name="dizhi2" type="text" id="dizhi2" value="<%=rs("dizhi")%>" />
      <input name="id" type="hidden" id="id" value="<%=rs("id")%>" /></td>
    <td height="30" align="center" class="content">
        <input type="submit" name="Submit" value="修改" />
    <a href="address.aspx?id=<%=rs("id")%>&amp;action=del" onClick="javascript:if(!confirm('\n特别提示！\n\n请慎重进行该操作！\n删除后将无法进行恢复。'))  return  false;">删除</a>
	 <a href="address1.aspx?shen_id=<%=rs("id")%>">添加市名</a>
 </td>
  </tr>
</form>
  <%rs.movenext
