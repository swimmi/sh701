...
"<a  onmouseout='hidetip2()' onmouseover=showtip2(this,event,'[肖虎]&nbsp;个性：意志坚强且活跃，为推荐人物，但因这些性格遇到困难会受打击而身败名裂。特征：胆大，做事果决，年轻时就会出人头地，中年时若能把握年轻时机运则会成功，若不能把握机运，则会在人际关系中衰败下来，不再成功．寅年出生的人，担任公教人员为宜，且要自爱，不要有贪念与争功的歪念．注意呼吸系统，消化系统的疾病。') href='#'>虎",
...
function mOvr(v) {
  ...
  if(sObj.innerHTML!='') {
      ...
      if(cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
         ...
         festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR="#999999"><TR><TD ALIGN="center">'+
         '<FONT COLOR="#ffffff" STYLE="font-size:9pt;">是日:'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
         '</TR></TABLE>';

      s= '<table border="1" width="180" bordercolor="#999999" bgcolor="#FFFBE8" cellpadding="0" cellspacing="0"><TR><td>' +
